...
function setup() {
    ...
    laPosicion = Math.floor(random(0,elArreglo.length)); //Math.round redondea el número para que JS no te tire un flotante (decimales). Math.floor redondea pa abajo.
